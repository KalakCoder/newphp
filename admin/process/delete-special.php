...
$query1= "DELETE FROM specials where id=$id";
...
if($result){
    ...
    echo "<meta http-equiv=\"refresh\" content=\"0;URL=../pages/specials/manage-special.php\">";

}
else{
    echo "Error,data is not deleted";
    header("Referesh:0; url=manage-special.php");  
}
}
?>